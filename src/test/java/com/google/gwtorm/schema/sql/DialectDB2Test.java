...
public class DialectDB2Test extends SqlDialectTest {
  ...
  public void setUp() throws Exception {
    ...
    final String database = "GERRIT"; // db
    final String user = "davido"; // schema
    final String pass = "magenta01"; // pwd

    db = DriverManager.getConnection("jdbc:db2://127.0.0.1:50001/" + database,
        user, pass);
        //":currentSchema=gwtorm;", user, pass);
