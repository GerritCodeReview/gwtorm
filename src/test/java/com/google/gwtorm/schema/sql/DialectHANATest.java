...
public class DialectHANATest extends SqlDialectTest {
  ...
  public void setUp() throws Exception {
    ...
    final String url = System.getProperty(HANA_URL_KEY);
    final String user = System.getProperty(HANA_USER_KEY);
    final String pass = System.getProperty(HANA_PASSWORD_KEY);
