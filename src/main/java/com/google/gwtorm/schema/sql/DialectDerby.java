...
public class DialectDerby extends SqlDialect {
  ...
  public String getLimitSql(String limitText) {
    return "FETCH FIRST " + limitText + " ROWS ONLY";
  }
  ...
  public String getCreateSequenceSql(SequenceModel seq) {
    ...
    /*
     * Derby starts with the smallest possible value, e.g typ INT = -2147483648.
     * see also https://db.apache.org/derby/docs/10.11/ref/rrefsqljcreatesequence.html
     * David Ostrovsky didn't say why this is potential problem in code review
     * But some gwtorm users (who?) seems to imply a start of 1 here?!
     * So be safe
     */
    r.append(" START WITH ");
